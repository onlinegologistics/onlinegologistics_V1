...
import { Calendar, ChevronLeft, ChevronRight, Filter, RefreshCw, AlertCircle } from 'lucide-react';
        ...
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            <div className="flex justify-between items-center mb-4">
                <div className="text-sm text-gray-600">
                    Showing <span className="font-semibold text-gray-800">{complaints.length}</span> of{' '}
                    <span className="font-semibold text-gray-800">{pagination.totalComplaints}</span> complaints
                </div>
                                    ...
                                    <tr key={ticket._id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="text-sm text-gray-900">
                                                {ticket.user?.mobile || ticket.contactMobile || '-'}
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
